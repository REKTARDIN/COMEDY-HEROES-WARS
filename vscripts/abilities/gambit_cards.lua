...
function gambit_cards:OnSpellStart()
    ...
    local cards_range = self:GetSpecialValueFor("cards_range") + caster:GetCastRangeBonus()
...
function gambit_cards:OnProjectileHit(hTarget, vLocation)
