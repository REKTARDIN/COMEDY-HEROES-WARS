...
function modifier_manhattan_energy_drain_buff:OnIntervalThink() self:GetParent():CalculateStatBonus(true) end
...
function modifier_manhattan_energy_drain_debuff:OnIntervalThink() self:GetParent():CalculateStatBonus(true) end
