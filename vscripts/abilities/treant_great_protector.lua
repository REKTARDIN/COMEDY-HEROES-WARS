...
LinkLuaModifier( "modifier_treant_great_protector", "abilities/treant_great_protector", LUA_MODIFIER_MOTION_NONE )
...
--------------------------------------------------------------------------------
if modifier_treant_great_protector == nil then modifier_treant_great_protector = class({}) end
...
function treant_great_protector:GetAbilityTextureName() return self.BaseClass.GetAbilityTextureName(self)  end 
