...
function item_courier:OnSpellStart ()
    if IsServer() then 
        ...
        local unit = self:GetCaster():GetPlayerOwner():SpawnCourierAtPosition(self:GetCaster():GetAbsOrigin())
        ...
        elseif Util:PlayerEquipedItem(self:GetCaster():GetPlayerOwnerID(), "onibi_2") == true then
            m_model = "models/items/courier/shibe_dog_cat/shibe_dog_cat.vmdl"
            m_model_flyuing = "models/items/courier/shibe_dog_cat/shibe_dog_cat_flying.vmdl"
            material = "1"
