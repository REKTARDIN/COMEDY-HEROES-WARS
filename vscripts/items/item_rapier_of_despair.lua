...
function modifier_item_rapier_of_despair_buff:DeclareFunctions() return {MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE, MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE} end
