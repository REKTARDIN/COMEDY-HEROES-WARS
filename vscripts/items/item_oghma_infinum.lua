if item_oghma_infinum == nil then item_oghma_infinum = class({}) end 

LinkLuaModifier ("modifier_item_necronomicon_4", "items/item_oghma_infinum.lua", LUA_MODIFIER_MOTION_NONE)

function item_oghma_infinum:GetIntrinsicModifierName()
	return "modifier_item_necronomicon_4"
end

function item_oghma_infinum:OnSpellStart()
	if IsServer() then 
...
function item_oghma_infinum:GetAbilityTextureName() return self.BaseClass.GetAbilityTextureName(self)  end 
