...
if modifier_attack_sound == nil then modifier_attack_sound = class({}) end

function modifier_attack_sound:IsHidden() return true end
function modifier_attack_sound:IsPurgable() return false end
function modifier_attack_sound:RemoveOnDeath() return false end
function modifier_attack_sound:DeclareFunctions()
    local funcs = {
        MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND
    }
...
function modifier_attack_sound:OnCreated(params)
    self.sound = params.sound
end


function modifier_attack_sound:GetAttackSound( params )
    return self.sound
end

if modifier_horseman_gambit == nil then modifier_horseman_gambit = class({}) end

function modifier_horseman_gambit:IsHidden() return true end
function modifier_horseman_gambit:IsPurgable() return false end
function modifier_horseman_gambit:RemoveOnDeath() return false end
function modifier_horseman_gambit:DeclareFunctions()
    local funcs = {
        MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND
    }
...
function modifier_horseman_gambit:GetAttackSound( params )
    return "Hero_MonkeyKing.Attack"
end
...
if modifier_ds_t == nil then modifier_ds_t = class({}) end
function modifier_ds_t:IsHidden() return true end
function modifier_ds_t:IsPurgable() return false end
function modifier_ds_t:RemoveOnDeath() return false end
function modifier_ds_t:DeclareFunctions ()
    local funcs = {
...
function modifier_ds_t:GetModifierTotalDamageOutgoing_Percentage( params )
    return 20
end